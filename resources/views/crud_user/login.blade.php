...
<div class="card-body">
    ...
    <div class="social-buttons d-flex justify-content-between gap-2">
        <a href="{{ route('social.login', 'google') }}" class="btn btn-outline-danger social-btn">
            <i class="fab fa-google"></i>Google
        </a>
        <a href="{{ route('social.login', 'facebook') }}" class="btn btn-outline-primary social-btn">
            <i class="fab fa-facebook-f"></i>Facebook
        </a>
        <a href="{{ route('social.login', 'github') }}" class="btn btn-outline-dark social-btn">
